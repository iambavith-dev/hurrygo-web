    ...
    return (
        <div className="flex items-center w-full flex-col" >
            <div className="gap-6 flex flex-col my-10 px-14 max-w-screen-lg" >
                ...
                <p className="mb-2" >Last updated: June 18, 2024</p>
                ...
                <ul className="flex flex-col gap-4" >
                    ...
                    <li>
                        <p><strong>Application</strong> refers to HurryGo, the software program provided by the Company.</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to HurryGo.</p>
                    </li>
                    <li>
                ...
                <h4 className="text-xl font-semibold" >Information Collected while Using the Application</h4>
                ...
                <ul>
                <li>By email: contact@hurrygo.in</li>
                </ul>
            </div>
        </div>
    )
